...
// ---------------------------------------------------------------------------
static const float TDLEAF_ADAM_LR0         = 0.13f;   // step size for FC layers (float weight units)
static const float TDLEAF_ADAM_FT_LR0      = 0.2f;    // step size for FT weights (sparse; need higher LR than dense FC)
static const float TDLEAF_ADAM_FT_BIAS_LR0 = 0.013f;  // step size for FT biases (10× slower than FC to prevent dying-ReLU)
